...
import { IGitHubProvider, Repositories, User as UserFromProvider } from "../../../providers/github/interfaces";
  ...
  it.each([
    {
      ...
      input: () => input,
      setup: () => {
        provider.getUserAndRepositoriesData.mockResolvedValueOnce(provider_result)
